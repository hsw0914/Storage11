...
$board = $db->query("SELECT * FROM `file_community` ORDER BY `idx` DESC LIMIT {$loadStart}, {$perPage}", array())->fetchAll();
$boardLength = $db->query("SELECT * FROM `file_community`", array())->rowCount();
?>
<div class="sub_con">
    <div class="sub_content_wrap">
        ...
        <div class="sub_more sub_view">
            ...
            <div class="paging">
                <?php paging($boardLength, $perPage, $page, 5,'/view/file/file/&&'); ?>
            </div>
        </div>
    </div>
</div>